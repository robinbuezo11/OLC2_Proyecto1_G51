...
DECLARE @ANDY INT = 12;
DECLARE @ANDRES1 INT = 13;
DECLARE @JOSE2 INT = 14;
DECLARE @SAMUEL3 INT = 15;
DECLARE @MARIO4 INT = 16;
DECLARE @ALLAN5 INT = 17;
DECLARE @ROBIN6 INT = 18;
DECLARE @ROBIN5 INT = 18;
DECLARE @ROBIN4 INT = 18;
DECLARE @ROBIN3 INT = 18;
DECLARE @ROBIN2 INT = 18;
DECLARE @ROBIN1 INT = 18; 
$$$
##