...
class Instruction:
    ...
    def changeTmp(self, tmps: dict[str, int]):
        if self.target and self.target != "H" and self.target != "P":
        ...
        if self.value and self.value != "H" and self.value != "P":
        ...
        if self.left and self.left != "H" and self.left != "P":
        ...
        if self.right and self.right != "H" and self.right != "P":
        ...
        if self.index and self.index != "H" and self.index != "P":
